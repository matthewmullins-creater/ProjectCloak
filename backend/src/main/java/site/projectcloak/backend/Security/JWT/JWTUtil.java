package site.projectcloak.backend.Security.JWT;
...
import site.projectcloak.backend.User.User;
import site.projectcloak.backend.User.UserService;
...
public class JWTUtil {
    ...
    public boolean verifyToken(String tokenString, UserService userService) {
        ...
        return (
            ...
            &&
            (issuer.compareTo("projectcloak.site") == 0) // same issuer
            &&
